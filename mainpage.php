		...
		<div class="container">
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						<li class="menu-active"><a href="mainpage.php">Home</a></li>
						<li class="menu-has-children"><a href="#">Student</a>
							<ul>
								<li><a href="subsinfo.html">Add Student information</a></li>
								<li><a href="showstudentinfo.php">Show Student information</a></li>
								<li><a href="Showresult.php">Show Result</a></li>
							</ul>
							<li class="menu-has-children"><a href="#">Teacher</a>
								<ul>
								<li><a href="studentresult.php">Add student result</a></li>
								<li><a href="showupdate1.php">Update result</a></li>
								<li><a href="showdelete1.php">Delete result</a></li>
									
								</ul>
						</li>
						<li><a href="https://www.google.com/maps/place/Daffodil+International+University/@23.7548853,90.3742164,17z/data=!3m1!4b1!4m5!3m4!1s0x3755b8ace928ae15:0xaa8023ec98f14cf5!8m2!3d23.7548804!4d90.3764051">Location</a></li>
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-center">
				<div class="banner-content col-lg-8 col-md-12">
					<h1 class="wow fadeIn" data-wow-duration="4s">Student Portal</h1>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Developed by | Mehedi Hasan <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"></a>
