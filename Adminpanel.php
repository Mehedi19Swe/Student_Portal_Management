				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li class="menu-has-children"><a href="#">Admin</a>
							<ul>
								<li><a href="admininfo.html">Add admin information</a></li>
								<li><a href="showinfo.php">Show information</a></li>
								<li><a href="showupdate.php">Update result</a></li>
								<li><a href="showdelete.php">Delete result</a></li>
							</ul>
